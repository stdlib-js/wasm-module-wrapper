...
```javascript
import Module from 'https://cdn.jsdelivr.net/gh/stdlib-js/wasm-module-wrapper@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/wasm-module-wrapper/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/wasm-module-wrapper/actions/workflows/test.yml?query=branch:v0.1.1
